...
export const caseStudyData: CaseStudy[] = [
  ...
  {
    id: 'twitter-sentiment-elections',
    title: 'Twitter Sentiment Analysis in Election Forecasting',
    company: 'Political Science Research',
    year: '2010-2016',
    summary: 'Researchers attempted to predict election outcomes from Twitter sentiment, claiming social media analysis could replace polling. Early papers reported high accuracy, but replications showed the results were highly sensitive to preprocessing choices — stop word lists, stemming algorithms, and sentiment lexicons produced wildly different conclusions from the same data.',
    violation: 'Fragility of text mining pipelines',
    violationTag: 'text-mining',
    lessonsLearned: [
      'Text preprocessing decisions (tokenization, stemming, stop words) are not neutral — they materially affect results.',
      'Sentiment lexicons trained on product reviews do not transfer well to political language.',
      'Always report sensitivity to preprocessing choices; a finding that flips with a different stemmer is not robust.',
    ],
    relatedChapter: '/ch10',
  },
  {
    id: 'google-flu-trends',
    title: 'Google Flu Trends: When Big Data Overfits',
    company: 'Google',
    year: '2008-2015',
    summary: 'Google Flu Trends used search query data to predict flu outbreaks in real time, initially outperforming CDC surveillance. But over time it dramatically overestimated flu prevalence — the model had overfit to seasonal search patterns and media-driven health scares. It was quietly shut down in 2015.',
    violation: 'Overfitting and concept drift in ML models',
    violationTag: 'neural-network',
    lessonsLearned: [
      'Models trained on correlations (search terms) without causal understanding are fragile to distribution shifts.',
      'Big data does not immunize against overfitting — 50 million search terms provide ample opportunity for spurious correlations.',
      'Deployed models need continuous monitoring; accuracy at launch does not guarantee accuracy over time.',
    ],
    relatedChapter: '/ch11',
  },
  {
    id: 'imagenet-bias',
    title: 'ImageNet and Bias in Deep Learning',
    company: 'AI Research Community',
    year: '2012-2020',
    summary: 'ImageNet, the benchmark that launched the deep learning revolution, was found to contain significant demographic biases. Models trained on it performed worse on images of people with darker skin tones and from non-Western countries. Transfer learning propagated these biases to downstream applications in healthcare, hiring, and law enforcement.',
    violation: 'Bias propagation through transfer learning',
    violationTag: 'deep-learning',
    lessonsLearned: [
      'Training data biases are inherited by the model and amplified — transfer learning can spread bias to new domains.',
      'Benchmark performance (top-1 accuracy on ImageNet) does not measure fairness or robustness across subgroups.',
      'Audit pre-trained models for bias before deploying them, especially in high-stakes applications.',
    ],
    relatedChapter: '/ch12',
  },
]
